...
class BasicWsvCharIterator {
	...
	getException(message) {
		return new BasicWsvParserError(this.lineIndex, this.index, message);
	}
}
...
class BasicWsvSerializer {
	...
	static serialize(lines) {
		...
		for (var line of lines) {
			...
			result += this.serializeLine(line);
		}
		return result;
	}
}